                ...
                <div className="container">
                    ...
                    <div className="row">
                            ...
                            <div className="domain-box">
                                ...
                                <div className="d-flex align-items-end justify-content-between">
                                    ...
                                    <a href="#" className="search-btn btn-fill-primary">
                                        <img src="/assets/images/pages/domains/icons/right-arrows.png" className="lazy img-fluid" alt="Image" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-2">
                            ...
                            <div className="domain-box">
                                {/* <!-- box-name --> */}
                                <h2 className="box-name"><span>.</span>xyz</h2>
                                {/* <!-- box-para --> */}
                                <p className="box-para">Brand your site as an organization for greater good.</p>
                                {/* <!-- div --> */}
                                <div className="d-flex align-items-end justify-content-between">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-2">
                            ...
                            <div className="domain-box">
                                {/* <!-- box-name --> */}
                                <h2 className="box-name"><span>.</span>biz</h2>
                                {/* <!-- box-para --> */}
                                <p className="box-para">Brand your site as an organization for greater good.</p>
                                {/* <!-- div --> */}
                                <div className="d-flex align-items-end justify-content-between">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-2">
                            ...
                            <div className="domain-box">
                                {/* <!-- box-name --> */}
                                <h2 className="box-name"><span>.</span>me</h2>
                                {/* <!-- box-para --> */}
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                ...
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/lock.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/lock-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                {/* <!-- box-icon --> */}
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/renew.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/renew-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                {/* <!-- box-icon --> */}
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/forward-button.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/forward-button-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                {/* <!-- box-icon --> */}
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/shield.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/shield-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                {/* <!-- box-icon --> */}
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/dns.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/dns-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                {/* <!-- box-icon --> */}
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/brain.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/brain-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                {/* <!-- box-icon --> */}
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/bell.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/bell-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
                        ...
                        <div className="col-xl-3 col-lg-4 col-md-6 mb-4">
                            ...
                            <div className="box">
                                {/* <!-- box-icon --> */}
                                <div className="box-icon d-flex align-items-center justify-content-start">
                                    <img src="/assets/images/pages/domains/icons/jack-cable.png" className="d-img lazy img-fluid" alt="Icon" />
                                    <img src="/assets/images/pages/domains/icons/jack-cable-l.png" className="l-img lazy img-fluid" alt="Icon" />
                                </div>
                                {/* <!-- box-title --> */}
